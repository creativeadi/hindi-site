...
const BoxDesign = ({ pattern, altText, title, description }) => {
  ...
  return (
    ...
    >
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-t from-black/0 via-black/0 to-transparent opacity-0 group-hover:opacity-0 transition-all duration-300"/>
      <div className="absolute inset-0 flex flex-col items-center justify-center p-4 transform transition-all duration-500">
        <h3 
          className={`font-samarka text-white text-2xl mb-2 text-center transform transition-all duration-500 ${
...
const HindiEvents = () => (
  <div className="relative group mb-12 max-w-3xl mx-auto">
    <div className="absolute -inset-1 bg-gradient-to-r from-orange-600/0 via-red-500/0 to-orange-600/0 rounded-lg blur opacity-0 group-hover:opacity-0 transition duration-1000 group-hover:duration-200 animate-gradient-xy"></div>
