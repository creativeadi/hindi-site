...
const HindiEvents = () => (
  <div className="relative mx-auto w-fit px-8 py-6 text-black group">
    <div className="absolute -top-8 -left-8 w-24 h-24 opacity-0 rotate-45 bg-orange-500 rounded-full 
      transition-all duration-500 group-hover:rotate-90 group-hover:scale-110" 
    />
    <div className="absolute -bottom-8 -right-8 w-24 h-24 opacity-0 -rotate-45 bg-orange-500 rounded-full 
      transition-all duration-500 group-hover:-rotate-90 group-hover:scale-110"
    />
    
    <div className="absolute inset-0 bg-gradient-to-r from-orange-200/0 to-orange-300/0 rotate-1 rounded-lg 
      transition-all duration-500 group-hover:rotate-2 group-hover:scale-105" />
    <div className="absolute inset-0 bg-gradient-to-l from-orange-100/0 to-transparent -rotate-1 rounded-lg 
      transition-all duration-500 group-hover:-rotate-2 group-hover:scale-105" />
    ...
    <div className="relative px-8 py-6 rounded-lg bg-gradient-to-r from-[#e1745d] to-[#ff8f7d] 
      ...
      <div className="relative">
        ...
        <h1 className="text-5xl md:text-6xl tracking-wider font-bold flex items-center justify-center gap-4"
          ...
          <span className="font-samarka relative text-orange-900 group-hover:text-orange-950 transition-colors duration-300">
            Hindi Club Events
